...
public class CustomBaseAdapterForLbPots extends BaseAdapter {
    Context context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = inflater.inflate(R.layout.custom_list_view_lbpots,null);
        TextView txtView = (TextView) convertView.findViewById(R.id.playerplace);
        TextView txtView2 = (TextView) convertView.findViewById(R.id.potionssold);
        ...
        txtView2.setText("Potions Sold: "+String.valueOf(arrayList.get(position).getPotionssold()));
        txtView3.setText(String.valueOf(arrayList.get(position).getUsername()));
        return convertView;
    }
    public CustomBaseAdapterForLbPots(Context ctx, ArrayList<User> arrayList,ArrayList<Integer> arrayList2){
        this.context=ctx;
